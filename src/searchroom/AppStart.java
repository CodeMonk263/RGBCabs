...
public class AppStart extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel2);
        jPanel2.setBounds(620, 220, 780, 640);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/searchroom/wp1898151.jpg"))); // NOI18N
        jPanel1.add(jLabel1);
    ...
    private void loginButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginButtonMouseClicked
        ...
        if(usernameField.getText().isEmpty()||password.length()==0){}
        else{
        Cursor c = new Cursor();
        if(c.login_page(usernameField.getText(),password)==1){
            this.setVisible(false);
            this.dispose();
