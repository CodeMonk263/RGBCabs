...
public class ViewTranscations extends javax.swing.JFrame {
     ...
     */
    private void displayWaitBookings(String Username){
        Cursor conn = new Cursor();
        ArrayList<ArrayList<String>> result;
        result = conn.getWaitData(Username);

        DefaultTableModel model = (DefaultTableModel) waitTable.getModel();
        model.setRowCount(0);
        ...
        for (int i = 0; i < result.size(); i++ ){
            ...
            row = result.get(i);
            String input_row [] = {row.get(0), row.get(1), row.get(2), row.get(3), row.get(4),row.get(5), row.get(6),row.get(7),row.get(8)};
    ...
    private void initComponents() {
        ...
        waitTable.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        waitTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Location", "HotelName", "From Date", "To Date", "Total Rooms", "Total Guests", "Ref Number", "Cost", "Preference"
            }
        ) {
            Class[] types = new Class [] {
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(modifyButton, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(46, 46, 46))
        );
    ...
    private void cancelButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cancelButtonMouseClicked
        ...
        try{
            ...
            String location = (String) model.getValueAt(index, 2);
            String hotelName = (String) model.getValueAt(index,3);
            if (date - today < 3) {
               int in_cost = Integer.parseInt((String)model.getValueAt(index, 8)); //250
                JOptionPane.showMessageDialog(null, "Cancellation Cost : " + (in_cost/2));
            }
                Cursor conn = new Cursor();
                conn.delete_row(ref);
